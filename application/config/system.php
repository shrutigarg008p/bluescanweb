...
$config['email_content_for_admin_FO_inspection']   = 'Hi,<br/><br/> Field Officer ##firstname## ##lastname## has inspect the site and scan the QR code successfully ! The site name is ##sitename## which is located in ##address##.<br/><br/><br/>Thanks & Regards<br/>BlueScan Team<br/>';

// content for customer when FO inspection his site
/*
$config['email_content_for_customer_FO_inspection']   = 'Hi ##customername##,<br/><br/>Field Officer ##firstname## ##lastname## has inspect the site and scan the QR code successfully ! The site name is ##sitename##  which is located in ##address##. <br/><br/><br/>Thanks & Regards<br/>BlueScan Team<br/>';*/
