...
error_reporting(0);
require_once(APPPATH . 'libraries/pdf/config/tcpdf_config.php'); 
...
class TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false) {
		...
		include_once(APPPATH . 'libraries/pdf/htmlcolors.php'); 
		$this->webcolor = $webcolor;
		// get array of custom spot colors
		if (file_exists( APPPATH . 'libraries/pdf/spotcolors.php')) {
			require( APPPATH . 'libraries/pdf/spotcolors.php');
			$this->spotcolor = $spotcolor;
		} else {
			$this->spotcolor = array();
		}
		require_once(APPPATH . 'libraries/pdf/unicode_data.php');
