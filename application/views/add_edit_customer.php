            ...
            <div class="row">
             ...
             <!--   <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                      <input tabindex="7" type="text" class="form-control" name="system_id" id="system_id" value="<?php echo set_value('system_id', $system_id); ?>" />
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                      <input tabindex="12" type="text" class="form-control" name="relational_contact" id="relational_contact" value="<?php echo set_value('relational_contact', $relational_contact); ?>" />
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                      <input tabindex="9" type="text" class="form-control" name="website" id="website" value="<?php echo set_value('website', $website); ?>" />
                    </div>                    
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                      ...
                      <input tabindex="11" type="text" class="form-control datepicker" name="date_of_engagement" id="date_of_engagement" value="<?php if(isset($date_of_engagement)&&!empty($date_of_engagement)){ echo set_value('date_of_engagement', date('Y-m-d',  strtotime($date_of_engagement)));}else{echo set_value('date_of_engagement');} ?>" />
                    </div>
                    <?php echo form_error('date_of_engagement');?> </div>
                </div>

                <div class="form-group">
                  <label class="col-md-4 control-label">Is Company Email Receive<span class="error"></span></label>
                  <div class="col-md-8">
                    <div class="input-group">
                    <input type="checkbox" name="is_company_notification_send" value="1" <?php if (!empty($is_company_notification_send)){echo ($is_company_notification_send==1 ? 'checked' : '') ;}?>/>
